...
* Building [Looker Studio report](https://lookerstudio.google.com/s/pd4-SfZl3rg) and [BigQuery queries](https://github.com/ehmtang/coffee-quality-database/blob/master/bq_sql.sql)
